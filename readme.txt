...
If you have ideas for improvements the code is up on [GitHub](https://github.com/afragen/the-events-calendar-outlook-invite-fix). Please feel free to fork it and submit a pull request.
